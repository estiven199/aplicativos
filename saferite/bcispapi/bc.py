...
class bcapi:  
    ...
    def get_categories(self,category_id): #bulk-pricing-rules
        return self._standard_call('catalog/categories/{}'.format(category_id),'GET','/v3/')     
    ...
    def get_customer_by_email(self,email):
      return self._standard_call('customers','GET','/v2/',email=email)
    def get_customer(self,customer_id):
      return self._standard_call('customers/' + str(customer_id),'GET','/v2/')         
    ...
    def list_products(self,**kwargs):
        return self._standard_call('orders/products','GET','/v3/',**kwargs)
